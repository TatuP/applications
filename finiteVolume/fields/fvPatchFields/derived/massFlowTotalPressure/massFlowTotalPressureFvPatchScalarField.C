...
#include "massFlowTotalPressureFvPatchScalarField.H"
...
Foam::massFlowTotalPressureFvPatchScalarField::massFlowTotalPressureFvPatchScalarField
(
    const fvPatch& p,
...
:
    ...
    massFlow_(readScalar(dict.lookup("massFlow"))), //p0_("p0", dict, p.size())
    Mave_(readScalar(dict.lookup("Mave"))) //p0_("p0", dict, p.size())
{
    if (dict.found("value"))
    {
...
Foam::massFlowTotalPressureFvPatchScalarField::massFlowTotalPressureFvPatchScalarField
(
    const massFlowTotalPressureFvPatchScalarField& ptf,
    const fvPatch& p,
    lconst DimensionedField<scalar, volMesh>& iF,
...
Foam::massFlowTotalPressureFvPatchScalarField::massFlowTotalPressureFvPatchScalarField
(
    const massFlowTotalPressureFvPatchScalarField& tppsf
)
:
...
void Foam::massFlowTotalPressureFvPatchScalarField::autoMap
(
...
void Foam::massFlowTotalPressureFvPatchScalarField::rmap
(
...
)
{
    ...
    const massFlowTotalPressureFvPatchScalarField& tiptf =
        refCast<const massFlowTotalPressureFvPatchScalarField>(ptf);
...
void Foam::massFlowTotalPressureFvPatchScalarField::write(Ostream& os) const
{
    ...
    writeEntry("value", os);
    //os.writeKeyword("") << gamma_ << token::END_STATEMENT << nl;
}
