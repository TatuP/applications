...
defineTypeNameAndDebug(tatunRNG, 0);
addToRunTimeSelectionTable(RASModel, tatunRNG, dictionary);
...
tmp<fvVectorMatrix> tatunRNG::divDevRhoReff(volVectorField& U) const
{
    return
    (
